...
const StudentsTable = () => {
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        const response = await axios.get("https://dashboard-backend-1-9919.onrender.com/students");
  ...
  const handleAddStudent = async () => {
    try {
      const response = await axios.post("https://dashboard-backend-1-9919.onrender.com/students", newStudent);
  ...
  const deleteStudent = async (id) => {
    try {
      await axios.delete(`https://dashboard-backend-1-9919.onrender.com/students/${id}`);
  ...
  const handleUpdateStudent = async () => {
    try {
      ...
      const response = await axios.put(
        `https://dashboard-backend-1-9919.onrender.com/students/${editStudent.id}`,
        updatedStudent
      );
  ...
  const courseImages = {
    "CBSE 9 Science": "/src/assets/sir.png",
    "CBSE 9 Math": "/src/assets/mam.png",
    "CBSE 10 Science": "/src/assets/sir.png",
    "CBSE 10 Math": "/src/assets/mam.png",
  };
